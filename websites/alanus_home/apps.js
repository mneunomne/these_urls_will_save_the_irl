...
$(document).ready(function() {
	...
	/* Social Wall Resize */
	if($(document).find('.ff-stream').length !== 0) {
	...
	*/
    ...
    $("a.fbp-enable").click(function(e){
        e.preventDefault();
        $.cookie('alanuswall', 'true', { expires: 365, path: '/'});
        //window.location.reload();
        window.location.href = window.location.href;
    });

    $("a.fbp-disable").click(function(e){
        e.preventDefault();
        $.cookie('alanuswall', 'false', { expires: 365, path: '/'});
        //window.location.reload();
        window.location.href = window.location.href;
    });
